...
if ($arParams['ENABLE_JQUERY'] == 'Y') {
    $Asset->addJs('/bitrix/components/custom/owlslider/js/jquery-1.9.1.min.js', true);
    /*$APPLICATION->AddHeadScript("/bitrix/components/custom/owlslider/js/jquery-1.9.1.min.js");*/
}
?>
...
<? if ($arParams['ENABLE_OWL_CSS_AND_JS'] == 'Y'): ?>
    ...
    <? /*<script src="/bitrix/components/custom/owlslider/js/owl.carousel.min.js" type="text/javascript"></script>*/ ?>
<? endif; ?>
